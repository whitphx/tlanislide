...
import { $currentSlide, getSlides, moveToSlide } from "./frame";
import { PresentationFlowProvider } from "./PresentationFlowProvider";
import { usePresentationFlow } from "./PresentationFlowContext";
...
function InnerApp() {
  ...
  const flow = usePresentationFlow();
  flow.pushStep({
    type: "camera",
    shapeId: slide1Id,
    zoomToBoundsParams: {
